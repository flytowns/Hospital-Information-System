...
<script>
//import "@/api/login.js"
//import {patientRegister} from "../api/register";
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(user);
      patientRegister(user).then(response => {
        if (response.data.code === 0) {
          ...
          this.$router.replace("/patient_login");
...
.login-wrap {
  ...
  width: 100%;
  height: 100%;
  background-image: url(../assets/img/neu15.jpg);
  background-size: 100%;
}
